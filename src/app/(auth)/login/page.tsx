 ...
 * UniVerse — Login Page
 * 
 * Styled to match the Interstellar Gargantua 3D Black Hole aesthetic
 * with ultra-translucent sci-fi glassmorphism card, Space Mono typography,
 * neon cyan focus glow, Marwadi University 1-tap domain autocomplete,
 * and cinematic warp jump on authentication.
 */
...
function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    if (isWarping || loading) return;

    const normalizedEmail = sanitizeEmail(email);
    const errs: typeof errors = {};
    if (!normalizedEmail) errs.email = "University email is required.";
  ...
  const showDomainChip =
    email.trim().length > 0 &&
    !emailValid &&
    (!email.includes("@") || email.endsWith("@") || email.endsWith("@m"));
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{
            ...
            width: 10,
            height: 10,
            borderLeft: "1px solid rgba(0, 210, 255, 0.6)",
            borderTop: "1px solid rgba(0, 210, 255, 0.6)",
          }}
        />
        <strong style={{ color: "#fff" }}>EVENT HORIZON</strong>
        <br />
      ...
      >
        <div
          style={{
            ...
            width: 10,
            height: 10,
            borderRight: "1px solid rgba(0, 210, 255, 0.6)",
            borderTop: "1px solid rgba(0, 210, 255, 0.6)",
          }}
        />
        <strong style={{ color: "#fff" }}>SYSTEM STATUS</strong>
        <br />
      ...
      >
        ...
        {/* ── Semi-Transparent Sci-Fi Glass Card (Matches Register Page) ── */}
        <div
          style={{
            width: "100%",
        ...
        >
          ...
          <div style={{ textAlign: "center" }}>
            ...
            >
              Sign into UniVerse — exclusively for Marwadi University
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div>
              ...
              {/* 1-Tap Autocomplete helper chip */}
              {showDomainChip && (
                <div style={{ marginTop: 6, display: "flex", justifyContent: "flex-end" }}>
                  ...
                  >
                    <span>+ @marwadiuniversity.ac.in</span>
                  </button>
                </div>
              )}
            </div>
              ...
              rightNode={
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  ...
                  <button
                    ...
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.color = showPw ? "#00d2ff" : "rgba(255, 255, 255, 0.45)")
                    }
            ...
            >
              ...
              >
                ...
                >
                  {remember && (
                    <svg viewBox="0 0 10 8" width="8" height="7" fill="none">
                      <path
                        d="M1 4l2.5 2.5L9 1"
                        stroke="black"
                        strokeWidth="2"
            ...
            >
              ...
              <Link
                ...
                style={{ color: "#00d2ff", fontWeight: 700, textDecoration: "none" }}
              >
                Create account &gt;
              </Link>
            </p>
