...
export const metadata: Metadata = {
  ...
  description:
    "UniVerse Campus Platform ke Terms of Service, Campus Rules, aur Prohibited Items List.",
};
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "48px 20px 0" }}>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {prohibitedItems.map((item, i) => (
              ...
              >
                ...
                <span style={{ fontSize: 13, color: "rgba(255,200,200,0.9)", fontWeight: 500 }}>{item.label}</span>
          ...
          >
            <p style={{ margin: 0, fontSize: 12, color: "#fbbf24", lineHeight: 1.7 }}>
              ⚠️ <strong>Zero Tolerance:</strong> Koi bhi prohibited item list karne par account{" "}
              <strong>turant permanently ban</strong> hoga aur student ka college enrollment ID{" "}
              <strong>university administration ko report</strong> kar di jayegi.
            </p>
          </div>
        </div>
        ...
        <Section title="10. Changes to Terms">
          ...
          <p style={{ marginTop: 12, color: "rgba(255,255,255,0.45)", fontSize: 12, fontFamily: "'Space Mono', monospace" }}>
            Last updated: September 2026 · Effective: From account creation date
          </p>
        </Section>
        ...
        >
          ...
          <p style={{ margin: "0 0 16px", fontSize: 13, color: "rgba(255,255,255,0.5)", lineHeight: 1.6 }}>
            Terms ke baare mein koi confusion ho to contact karein.
          </p>
          <a
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 20, flexWrap: "wrap" }}>
          ...
          <Link href="/register" style={{ color: "#00d2ff", textDecoration: "none", fontSize: 12, fontFamily: "'Space Mono', monospace" }}>Create Account →</Link>
          <span style={{ color: "rgba(255,255,255,0.15)" }}>•</span>
