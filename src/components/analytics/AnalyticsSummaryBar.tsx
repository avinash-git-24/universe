...
export function AnalyticsSummaryBar({
  ...
  return (
    <div className="border border-white/5 rounded-2xl w-full grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-[1px] bg-white/5 overflow-hidden">
      
      {/* Average Spent */}
      <div className="flex items-center gap-3 sm:gap-4 p-4 sm:p-5 bg-[#0d1310] hover:bg-white/5 transition-colors">
      ...
      {/* Cancelled Requests */}
      <div className="col-span-2 sm:col-span-1 flex items-center gap-3 sm:gap-4 p-4 sm:p-5 bg-[#0d1310] hover:bg-white/5 transition-colors">
