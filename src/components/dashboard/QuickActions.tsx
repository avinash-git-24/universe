...
import { Plus, ChevronRight, FileText, Bike, ShoppingBag, MessageSquare, BarChart2 } from "lucide-react";
...
export function QuickActions() {
  ...
  return (
    <div className="bg-[#0a0f0c]/40 border border-white/10 hover:border-emerald-500/30 rounded-2xl sm:rounded-3xl p-5 sm:p-6 backdrop-blur-xl shadow-lg flex flex-col gap-4 relative overflow-hidden transition-all group">
